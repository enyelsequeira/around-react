...
const PopupWithForm = () => (
  <div>
    ...
    <div className="modal modal__card">
      <div className="modal__info">
        <button
          className="modal__close modal__card-close"
        ...
        <form className="modal__form">
          ...
          <button
            className="modal__save-button modal__form-create modal__save"
            type="submit"
            value="save">
            {' '}
            Create{' '}
    ...
    <div className="modal modal__deleteimage">
      <div className="modal__info">
        ...
        <form className="modal__form">
          ...
          <button className="modal__save-button " type="submit" value="save">
            {' '}
            Yes{' '}
          </button>
        </form>
